        ...
        <aside className="products-sidebar">
          ...
          <div className="sidebar-section">
            ...
            <div className="tag-filters">
              {['Electronics', 'Clothing', 'Home', 'Books', 'Beauty', 'Sports', 'Spiritual', 'Other'].map(tag => (
                <button
                  key={tag}
              ...
              filteredProducts?.map(product => (
                ...
                >
                  <div className="product-image">
                    <img src={product.images} alt={product.name} onClick={() => handleOpenProductDetail(product?.id)} />
                  ...
                  <div className="product-info" onClick={() => handleOpenProductDetail(product?.id)}>
