...
//               <div className="stat-value">{formatCurrency(stats.todayTotalAmount)}</div>
//             </div>
//           </div>

//           <div className="stat-card pages-card">
//             <div className="stat-icon">📄</div>
//             <div className="stat-content">
//               <h3>Total Pages</h3>
...
//                   {orders.map((order) => (
//                     <tr key={order._id}>
//                       <td className="order-id">{shortenId(order._id)}</td>
...
//                       <span className="order-id-mobile">{shortenId(order._id)}</span>
...
//                         <span className="price-mobile">{formatCurrency(order.totalPrice)}</span>
//                       </div>
//                     </div>
//                   </div>
//                 ))}
...
//                     {Array.from({ length: stats.totalPages }, (_, i) => i + 1).map((pageNum) => (
//                       <button
//                         key={pageNum}
